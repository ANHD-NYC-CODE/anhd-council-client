  ...
  return {
    ...
    optimization: {
      ...
      minimizer: [
        ...
        new TerserPlugin({
          ...
          parallel: true,
          // Enable file caching
          // cache: true, // Removed as it's not supported in newer versions
        }),
        // This is only used in production mode
    ...
    resolve: {
      ...
      alias: {
        ...
        'AdvancedSearch': path.resolve(__dirname, '../src/AdvancedSearch'),
        'DistrictDashboard': path.resolve(__dirname, '../src/DistrictDashboard'),
        'MyDashboard': path.resolve(__dirname, '../src/MyDashboard'),
        'Layout': path.resolve(__dirname, '../src/Layout'),
        'Lookup': path.resolve(__dirname, '../src/Lookup'),
        'Main': path.resolve(__dirname, '../src/Main'),
        'Config': path.resolve(__dirname, '../src/Config'),
        'LeafletMap': path.resolve(__dirname, '../src/LeafletMap'),
