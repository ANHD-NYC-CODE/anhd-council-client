...
describe('convertConditionMappingToQ', () => {
  ...
  describe('1 AND filter(1 1 OR filter(2', () => {
    it('converts the object into a Q', () => {
      let condition0Filters = [filterMocks['hpd_violations'], new ConditionFilter({ conditionGroup: '1' })]

      let condition1Filters = [filterMocks['dob_violations'], filterMocks['ecb_violations']]
